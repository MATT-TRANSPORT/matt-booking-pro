...
export default async function PanelPage() {
  ...
  for(const b of activeBookings){
    ...
    for(const leg of legs){const currentLive=activePastLeg?.kind===leg.kind;if(!currentLive&&leg.operationalEndKey<nowKey)continue;upcoming.push({kind:"booking",sortKey:currentLive?`0000-${nowKey}`:`1000-${leg.operationalStartKey}`,leg,data:b,currentLive})}
  }
